            ...
            @foreach ($paquetes as $paquete)
                <div class=" p-6 bg-transparent flex justify-between items-center bg-transparent">
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-300">Created: {{ $paquete->created_at->format('Y-m-d') }}</p>
                        <p class="text-gray-600 dark:text-gray-300">Updated: {{ $paquete->updated_at->format('Y-m-d') }}</p>
                    </div>
